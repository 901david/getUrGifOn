...
$(document).ready(function(){
	...
	$.ajax({
		...
		for (var i = 0; i < 9; i++){
			...
			$(".imageArea").append("<div class='col-xs-12 col-s-4 col-md-2 col-lg-2'><span>Ratng: " + response.data[i].rating.toUpperCase() + "</span><br/><img class='img-responsive' src='" + response.data[i].images.fixed_width.url + "'>");
		};
	});
	searchForImages();
